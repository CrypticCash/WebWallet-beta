  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        <strong><?php echo $lang['WALLET_SEND']; ?></strong></a>
      </h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        <strong><?php echo $lang['WALLET_PASSUPDATE']; ?></strong></a>
      </h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
       ...
       <strong>Receive Address</strong></a>
      </h4>
    </div>
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        <strong><?php echo $lang['WALLET_LAST10']; ?></strong></a>
      </h4>
    </div>
