...
<html>
    <head>
        ...
        <meta name="description" content="Cryptic Cash Web Wallet - Peer-to-Peer Electronic Cash System ">
        <meta name="author" content="Cryptic Cash">
        ...
        <title>Cryptic Cash Web-Wallet - Peer-to-Peer Electronic Cash System</title>
        <link rel="shortcut icon" href="http://explorer.crypticcash.org/images/cryptic.jpeg">
    </head>
    ...
    <body>
        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header">
					<a class="navbar-brand" href="index.php"><img src="https://crypticcash.org/wp-content/uploads/2018/04/logo.png" alt="Cryptic Cash Wallet" width="120"></a>				
				</div>
        ...
        <div class="jumbotron" style="background-image: url(http://crypticcash.org/wp-content/uploads/2018/04/picture17_currency.jpg) !important;">
            <div class="container">
